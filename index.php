  ...
  <body>
    ...
    <h2 class="hide">An Intro to The Island</h2>
        ...
        <div class="small-12 medium-6 large-5 columns">
            ...
            <div class="center hide-for-medium"><a href="#aboutIntro"><img class="downarrow" src="images/blackarrow.svg"></a></div>
        </div>
    </section>
    ...
    <h2 class="hide">An Into to Donation</h2>
        ...
        <div id="donation" class="small-12 medium-6 large-5 columns">
